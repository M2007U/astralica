...
prime numbers that are < 64 and not 2,3 or 5
...
>[!example]
>take the number 41 (in base ten),
>it is on the 2nd row (2 strokes on the right),
>and it is the first annoying numbers in that row (here we start counting from 0)
