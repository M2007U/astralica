...
*to some extend, these 2 are actually quite equivalent it is just that each of them are on both sides on a spectrum*

Here we have ways to crank a trait
- One Excessive
- one Suitable and Neutral
- one Lacks

|                                            |                                                          |              |
| ------------------------------------------ | -------------------------------------------------------- | ------------ |
| ![[Event_Adjective_Crank_Low.png\|100]]    | /Sæyanæ - Klari - KaxiTæ/<br>/Sæ - Kla - KaTæ/<br>/Sklæ/ | Crank Low    |
| ![[Event_Adjective_Crank_Medium.png\|100]] | /Sæyanæ - Klari - KaxiTo/<br>/Sæ - Kla - KaTo/<br>/Sklo/ | Crank Medium |
| ![[Event_Adjective_Crank_High.png\|100]]   | /Sæyanæ - Klari - KaxiTa/<br>/Sæ - Kla - KaTa/<br>/Skla/ | Crank High   |


>[!example]
>let's take "narrow" and "wide" as an example,
...
## Subjective Describing *(Comfort Zones)*

Here we can attach information if the level of the adjective is
- desirable
- acceptable
- neutral
- toleratable
...
here the  [[🟡 02 - Modification Characters]] group can be treated as a "comfort zone circle"

*(here, all are done with Crank-High, but of course this also works with Crank-Medium and Crank-Low)*

|                                         |                                         |                                         |                                         |                                         |
| :-------------------------------------: | :-------------------------------------: | :-------------------------------------: | :-------------------------------------: | :-------------------------------------: |
| ![[Event_Adjective_Crank_High.png\|50]] | ![[Event_Adjective_Crank_High.png\|50]] | ![[Event_Adjective_Crank_High.png\|50]] | ![[Event_Adjective_Crank_High.png\|50]] | ![[Event_Adjective_Crank_High.png\|50]] |
|          ![[Circle0.png\|50]]           |          ![[Circle1.png\|50]]           |          ![[Circle2.png\|50]]           |          ![[Circle3.png\|50]]           |          ![[Circle4.png\|50]]           |
|               /Skla-æru/                |               /Skla-æro/                |               /Skla-æri/                |               /Skla-æræ/                |               /Skla-æra/                |
|                /Sklaru/                 |                /Sklaro/                 |                /Sklari/                 |                /Sklaræ/                 |                /Sklara/                 |
|                 Perfect                 |               Acceptable                |                 Neutral                 |               Toleratable               |               Undesirable               |

here, the way we crop the pronunciation is : $(Skla/Sklæ)(ru/ro/ri/ræ/ra)$
...
## Objective Relative Describing *(Comparing)*
...
>**/ A Kaklana-Sklæmara B /**
>
>/Kaklana/ : refers to "the Quantification of Space in 3D", in other words, "size"
>/Sklæ/ : refers to the lack of size, in other words, "smallness"
>/mara/ : means the noun on the right *(which in this example is B)* has more "smallness"
>
>translated to English it can be "B is smaller than A"
...
then the "skl(a/o/æ)( (r(a/æ/i/o/u))/(mæ/ma/ta/t)æ)" segment should go to the front instead.
if this adjective is used inside a [[🟡 02 - Kosra Information Segment]], then the segment stays at the back to act as a "Kosra information Segment Item value"

If the adjective uses Subjective Describing,
then it is not transitive because it is only describing itself

If the adjective uses Objective Relative Describing,
